...
public class Config {
    ...
    public static FaceTecCustomization currentCustomization = retrieveConfigurationWizardCustomization(null);
    ...
    public static void initializeFaceTecSDKFromAutogeneratedConfig(Boolean isProd, String faceTecSDKKey, String publicFaceScanEncryptionKey, String serverUrl, Context context, @Nullable String prodKeyText, FaceTecSDK.InitializeCallback callback) {
        DeviceKeyIdentifier = faceTecSDKKey;
        BaseURL = serverUrl;

        if (isProd && prodKeyText != null) {
            FaceTecSDK.initializeInProductionMode(context, prodKeyText, faceTecSDKKey, publicFaceScanEncryptionKey, callback);
        } else {
            FaceTecSDK.initializeInDevelopmentMode(context, faceTecSDKKey, publicFaceScanEncryptionKey, callback);
        }
    }
    ...
    public static FaceTecCustomization retrieveConfigurationWizardCustomization (@Nullable ReadableMap theme) {
        ...
        if (theme != null && theme.hasKey("Colors")) {
            ReadableMap colorMap = theme.getMap("Colors");
            if (colorMap != null) {
                if (colorMap.hasKey("frameColor")) {
                    frameColor = Color.parseColor(colorMap.getString("frameColor"));
                }
                if (colorMap.hasKey("borderColor")) {
                    borderColor = Color.parseColor(colorMap.getString("borderColor"));
                }
                if (colorMap.hasKey("ovalColor")) {
                    ovalColor = Color.parseColor(colorMap.getString("ovalColor"));
                }
                if (colorMap.hasKey("dualSpinnerColor")) {
                    dualSpinnerColor = Color.parseColor(colorMap.getString("dualSpinnerColor"));
                }
                if (colorMap.hasKey("textColor")) {
                    textColor = Color.parseColor(colorMap.getString("textColor"));

                }
                if (colorMap.hasKey("buttonAndFeedbackBarColor")) {
                    buttonAndFeedbackBarColor = Color.parseColor(colorMap.getString("buttonAndFeedbackBarColor"));
                }

                if (colorMap.hasKey("buttonAndFeedbackBarTextColor")) {
                    buttonAndFeedbackBarTextColor = Color.parseColor(colorMap.getString("buttonAndFeedbackBarTextColor"));

                }

                if (colorMap.hasKey("buttonColorHighlight")) {
                    buttonColorHighlight = Color.parseColor(colorMap.getString("buttonColorHighlight"));


                }
                if (colorMap.hasKey("buttonColorDisabled")) {
                    buttonColorDisabled = Color.parseColor(colorMap.getString("buttonColorDisabled"));
...
//        defaultCustomization.getCancelButtonCustomization().customImage = cancelButtonImage;
    ...
    public static FaceTecCustomization retrieveLowLightConfigurationWizardCustomization() {
        return retrieveConfigurationWizardCustomization(null);
    }
